...
const localOnlyPages = ['asr-test.astro', 'backlog.astro', 'dashboard.astro', 'pipeline.astro', 'progress.astro', 'recent.astro', 'review.astro', 'source-discovery.astro', 'research.astro'];
const movedPages = [];
